    ...
    <footer className="bg-gray-900 text-gray-400">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-xl font-bold text-white">36BIKES</span>
            </div>
            <p className="text-sm text-gray-400 mb-4">
              Premium marketplace for modern cyclists. Buy, sell, and get certified expert inspections for high-performance bicycles.
            </p>
        ...
        <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row md:items-center md:justify-between">
          <p className="text-sm text-gray-500">© 2024 36 Bikes Marketplace Inc. All rights reserved.</p>
          <div className="flex items-center gap-4 mt-4 md:mt-0" aria-hidden="true">
